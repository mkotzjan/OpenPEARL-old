...
#define HOST_DEVICE_SETTLE_DELAY_MS   3    // 3 poll cycles should be enoiugh
#include "Host.h"
...
void USB_Host_ProcessNextHostState(uint8_t corenum)
{
	...
	case HOST_STATE_Powered_WaitForConnect:
		...
		HOST_TASK_NONBLOCK_WAIT(corenum, 2, HOST_STATE_Powered_DoReset);
		break;
	...
	case HOST_STATE_Powered_DoReset: {
		...
		HOST_TASK_NONBLOCK_WAIT(corenum, 2, HOST_STATE_Powered_ConfigPipe);
	}
	break;
	...
	case HOST_STATE_Default: {
		...
		HOST_TASK_NONBLOCK_WAIT(corenum, 2, HOST_STATE_Default_PostReset);
	}
	break;
	...
	//	HOST_TASK_NONBLOCK_WAIT(corenum, 100, HOST_STATE_Default_PostAddressSet);
		HOST_TASK_NONBLOCK_WAIT(corenum, 5, HOST_STATE_Default_PostAddressSet);
		break;
