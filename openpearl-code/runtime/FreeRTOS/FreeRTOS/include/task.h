...
#ifdef configUSE_STATIC_STACK_AND_TCB
/* used to pass two additional pointers to xTaskCreate()

required for the static tcb and stack version. the adresses of both must be passed */
typedef struct CreateTaskParameters {
                void * tcb;
                void * stack;
                void * pvParameter;
        } StructParameters_t;
