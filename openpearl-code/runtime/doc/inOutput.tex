...
SYSTEM;
   ...
   temp: LM75('48'B4) --- i2c;        ! one temperatur
                                      ...
                                      ! the bus i2c
PROBLEM;
   SPC LM75 DATION SYSTEM BASIC FIXED(15);
MODEND;
\end{PEARLCode}

\begin{CppCode}
static pearlrt::I2CBus s_i2cbus("/dev/i2c-0",100000);
static pearlrt::Device * d_i2cbus = &s_i2cbus;

static pearlrt::LM75 s_temp(&s_i2cbus,0x48);
...
The classes for provider and client are derived from \texttt{SystemDationB}
and a connection specific pair of provider and client classes - e.g. 
\texttt{I2CBusProvider} and \texttt{I2CBusClient}. These classes
provide the communication between provider and client, if required.
