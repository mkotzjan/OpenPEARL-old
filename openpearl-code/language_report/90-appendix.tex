...
{\bf BY} \ref{sec_repetition}, \ref{sec_open_close}\\
...
{\bf GLOBAL} \ref{sec_references_modules}\\
{\bf GOTO} \ref{sec_goto}\\
 
{\bf HRS} \ref{sec_type_duration}\\
 
{\bf IDENTICAL}, {\bf IDENT} \ref{sec_spc}, 8.1\\
{\bf IF} \ref{sec_if}\\                           
...
{\bf INTERRUPT}, {\bf IRPT} \ref{sec_interrupt}\\
{\bf INV} \ref{sec_inv}\\
...
{\bf ISNT} \ref{sec_refernces}, \ref{sec_dyadic_operators}\\
