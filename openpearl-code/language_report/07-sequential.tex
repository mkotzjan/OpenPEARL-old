...
\index{Statement!Conditional (IF)}
...
\index{Statement!Selection (CASE)}
...
\index{CASE@\textbf{OUT}}
\index{CASE@\textbf{FIN}}
...
\index{Statement!Repetition (FOR)}
...
\index{FOR@\textbf{FOR}!Repetition}
\index{FROM@\textbf{FROM}!Repetition}
\index{TO@\textbf{TO}!Repetition}
\index{BY@\textbf{BY}!Repetition}
\index{WHILE@\textbf{WHILE}!Repetition}
\index{REPEAT@\textbf{REPEAT}}
\index{END@\textbf{END}!Repetition}
...
\label{sec_exit}
\index{Statement!Leave block (EXIT)}
