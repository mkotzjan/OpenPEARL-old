...
\end{grammar}
\begin{discuss}
simpleSTartCondition should be  in grammar
\end{discuss}
...
\end{grammar}
\begin{discuss}
fehlt hier nicht eine [..] um die simpleStartCondition?
\end{discuss}
...
\end{front}
\begin{grammar}
included in InterruptStatement
\end{grammar}
\begin{discuss}
InterruptStatement := \{ EnaleStatement $\mid$ DisableStatement $\mid$ TriggerStatement \}
